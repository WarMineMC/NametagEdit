package ru.warmine.minigames.utils;
...
public class Utils {
    ...
    public static String format(String input, boolean limitChars) {
        ...
        if(VersionChecker.getBukkitVersion() == VersionChecker.BukkitVersion.v1_13_R1) {
            ...
            return limitChars && colored.length() > 128 ? colored.substring(0, 128) : colored;
        } else if(VersionChecker.getBukkitVersion() == VersionChecker.BukkitVersion.v1_16_R1) {
            return limitChars && colored.length() > 128 ? colored.substring(0, 128) : colored;
        } else if(VersionChecker.getBukkitVersion() == VersionChecker.BukkitVersion.v1_16_R2) {
            return limitChars && colored.length() > 128 ? colored.substring(0, 128) : colored;
        } else if(VersionChecker.getBukkitVersion() == VersionChecker.BukkitVersion.v1_16_R3) {
            return limitChars && colored.length() > 128 ? colored.substring(0, 128) : colored;
        } else {
